 ...
 * Gera HTML com OG tags apontando para uma imagem Cloudinary 1200x627.
 * Uso: /api/p?n=Nome&fs=27&x=140&y=50&co=2b2b2b&o=60&blur=8
 */
export default function handler(req, res) {
  ...
  const o    = Math.max(0, Math.min(100, Number(q.o ?? 60)));
  ...
  // Overlay + normalização p/ 1200x627 (sem crop) + força JPEG
  const ogImage =
  ...
  // Título/descrição "invisíveis" (zero-width space)
  const ZWSP = '\\u200B';
